...
-- ----------------------------------------------------------------------------
-- The cost to execute Plutus scripts
--

data ScriptExecutionUnits where
    ScriptExecutionUnits :: Word64
                         -- ^ Memory
                         -> Word64
                         -- ^ Steps
                         -> ScriptExecutionUnits

deriving instance Show ScriptExecutionUnits
deriving instance Eq ScriptExecutionUnits
